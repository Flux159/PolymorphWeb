...
public class NonOVRPlayerLookAtStartMenuScript : MonoBehaviour
{
		...
		void Update ()
		{
				...
				if (Physics.Raycast (leftRay, out leftHit, 100)) {
						...
						if (focus != null && focus.IsFocusable ()) {
								...
								if (lifeBarObject == null) {
										...
										lifeBarObject = (GameObject)Instantiate (particlePrefab, leftHit.point - .8f * lifeBarObjectForwardDirection, direction);
								}
